...
import com.example.employeeManagment.repository.AttendanceRepository;
...
public class AttendanceService {
	...
	public long countByEmployeeIdAndDepartmentIdAndAvailable(String employeeid, String departmentid,
			Boolean available) {
		long attendanceList = attendancerepository.countByEmployeeIdAndDepartmentIdAndAvailable(employeeid,
	...
	public AttendanceDetails[] findBydeptid(String departmentid) {
		AttendanceDetails[] attendanceList = (AttendanceDetails[]) attendancerepository
	...
	public AttendanceDetails findByName(String employeeid, String departmentid) {
		AttendanceDetails attendanceList = (AttendanceDetails) attendancerepository
				.findByEmployeeIdAndDepartmentId(employeeid, departmentid);
...
//			}
	...
	public String updateUser(String employeeid, Boolean available, String date) {
		AttendanceDetails attendanceList = (AttendanceDetails) attendancerepository.findByEmployeeIdAndDate(employeeid,
				date);
		if (attendanceList != null) {
